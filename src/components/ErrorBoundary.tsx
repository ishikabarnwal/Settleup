    ...
    return (
      <div role="alert" className="flex min-h-dvh items-center justify-center bg-canvas px-6">
        <div className="max-w-sm text-center">
          <p className="text-sm font-medium tracking-wide text-plum uppercase">Something broke</p>
          ...
          <div className="mt-6 flex justify-center gap-2">
            <button
              ...
              className="h-10 rounded-control bg-plum px-4 text-sm font-medium text-white"
            >
              Reload
            </button>
            <a
              href="/"
              className="inline-flex h-10 items-center rounded-control px-4 text-sm font-medium text-stone-700 ring-1 ring-stone-300 ring-inset"
            >
              Go to your groups
            </a>
          </div>
